...
4. Enter a stack name and proceed to fill in the parameters. The ones needed at minimum are KeyName (used to SSH into the FTD and FMC) and AddFMC (if you need an FMC).
